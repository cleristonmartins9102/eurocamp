import { LoadSumOfFirstAndLastLetterFromList } from '../data/features/load-sum-of-first-and-last-digit-from-list'
...
export class DayOneController {
  ...
  async handler (): Promise<number> {
    ...
    const loadSum = new LoadSumOfFirstAndLastLetterFromList()
